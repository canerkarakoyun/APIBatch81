...
public class Get07 extends JsonplaceholderBaseUrl {
    ...
    public void get01(){
        ...
        //System.out.println("Id'si 5'den kucuk olanlarin user Id'leri : "+userIdler);
        ...
        System.out.println("Id'si 5'den kucuk olanlarin titlelari : "+titles);

        // Assert that "delectus aut autem" is one of the titles whose id is less than 5 ==> id si 5 den kucuk olan datalarin birinin
        assertTrue("Title'lardan herhangi bir tanesi 'delectus aut autem' icermemektedir",
                titles.contains("delectus aut autem"));

        // 2. dosgrulama yontemi
        assertTrue("Title'lardan herhangi bir tanesi 'delectus aut autem' icermemektedir",
